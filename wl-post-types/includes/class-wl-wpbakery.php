			...
			array(
				...
				'params'      => array(
					...
					array(
						...
						'param_name'  => 'orderby',
						'value'       => array(
							__( 'Recently Added', 'waterslaw' ) => 'added',
							__( 'Publish Date', 'waterslaw' )   => 'date',
							__( 'Last Modified', 'waterslaw' )  => 'modified',
							__( 'Title', 'waterslaw' )          => 'title',
							__( 'Menu Order', 'waterslaw' )     => 'menu_order',
						),
						'std'         => 'added',
						'description' => __( 'Recently Added uses the order posts were added to the site, so an article back-dated to an older year still shows first when you upload it. Publish Date uses the date printed on the card.', 'waterslaw' ),
					),
					array(
						'type'        => 'dropdown',
						'heading'     => __( 'Order', 'waterslaw' ),
						'param_name'  => 'order',
						'value'       => array(
							__( 'Descending (newest first)', 'waterslaw' ) => 'DESC',
							__( 'Ascending (oldest first)', 'waterslaw' )  => 'ASC',
						),
						'std'         => 'DESC',
						'description' => __( 'The first post in this order becomes the big featured post on the left.', 'waterslaw' ),
					),
					self::toggle( __( 'Show Excerpt', 'waterslaw' ), 'show_excerpt', 'yes', array( 'group' => $list ) ),
					array(
						'type'        => 'textfield',
						'heading'     => __( 'Excerpt Word Limit', 'waterslaw' ),
						'param_name'  => 'excerpt_words',
						'value'       => '15',
						'group'       => $list,
						'dependency'  => array( 'element' => 'show_excerpt', 'value' => 'yes' ),
						'description' => __( 'Words to keep before the ellipsis. Between 1 and 100.', 'waterslaw' ),
					),
					self::color( __( 'Excerpt Color', 'waterslaw' ), 'excerpt_color', '#5b6b7a', $list ),
					self::size( __( 'Excerpt Font Size', 'waterslaw' ), 'excerpt_size', '14', $list ),
					self::size( __( 'Space Below Excerpt', 'waterslaw' ), 'excerpt_space', '10', $list ),
					...
					self::size( __( 'Meta Font Size', 'waterslaw' ), 'meta_size', '12', __( 'Meta', 'waterslaw' ) ),
					self::size( __( 'Meta Gap (side to side)', 'waterslaw' ), 'meta_gap', '14', __( 'Meta', 'waterslaw' ) ),
					self::size( __( 'Meta Gap (between lines)', 'waterslaw' ), 'meta_row_gap', '6', __( 'Meta', 'waterslaw' ), array( 'description' => __( 'Only shows when the meta wraps onto a second line.', 'waterslaw' ) ) ),
					array(
						'type'             => 'dropdown',
						'heading'          => __( 'Meta Wrapping', 'waterslaw' ),
						'param_name'       => 'meta_wrap',
						'value'            => array(
							__( 'Wrap onto more lines', 'waterslaw' ) => 'wrap',
							__( 'Keep on one line', 'waterslaw' )     => 'nowrap',
						),
						'std'              => 'wrap',
						'group'            => __( 'Meta', 'waterslaw' ),
						'edit_field_class' => 'vc_col-sm-6',
						'description'      => __( 'One line is tighter, but long author or category names may be cut off.', 'waterslaw' ),
					),
					self::size( __( 'Space Below Title', 'waterslaw' ), 'title_space', '8', __( 'Meta', 'waterslaw' ) ),
					self::size( __( 'Space Below Meta', 'waterslaw' ), 'meta_space', '10', __( 'Meta', 'waterslaw' ) ),
					...
					self::size( __( 'Font Size', 'waterslaw' ), 'btn_size', '12', $button ),
					array(
						'type'             => 'dropdown',
						'heading'          => __( 'Font Weight', 'waterslaw' ),
						'param_name'       => 'btn_weight',
						'value'            => array(
							__( 'Normal', 'waterslaw' )     => '400',
							__( 'Light', 'waterslaw' )      => '300',
					...
					self::size( __( 'Letter Spacing', 'waterslaw' ), 'btn_spacing', '', $button, array( 'description' => __( 'In pixels. Leave empty for the default 0.5.', 'waterslaw' ) ) ),
					self::size( __( 'Border Width', 'waterslaw' ), 'btn_border_width', '1', $button ),
