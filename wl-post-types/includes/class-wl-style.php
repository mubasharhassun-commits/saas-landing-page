...
class WL_Style {
	...
	public static function news_schema() {
		return array(
			...
			'excerpt_color'         => array( 'var' => '--wl-news-excerpt-color', 'type' => 'color' ),
			'excerpt_size'          => array( 'var' => '--wl-news-excerpt-size', 'type' => 'px', 'min' => 8, 'max' => 40 ),
			'excerpt_space'         => array( 'var' => '--wl-news-excerpt-space', 'type' => 'px', 'max' => 60 ),
