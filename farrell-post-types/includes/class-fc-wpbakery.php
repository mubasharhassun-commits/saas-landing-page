		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => __( 'Excerpt Word Limit', 'farrell' ),
						'param_name'  => 'excerpt_words',
						'value'       => '20',
						'group'       => $content,
						'dependency'  => array( 'element' => 'show_excerpt', 'value' => 'yes' ),
						'description' => __( 'Words to keep before the ellipsis.', 'farrell' ),
					),
					array(
						'type'        => 'textfield',
						'heading'     => __( 'Title Word Limit', 'farrell' ),
					...
					self::size( __( 'Featured Column Width (%)', 'farrell' ), 'featured_width', '48', $layout, array( 'description' => __( 'Percent of the row the featured story takes.', 'farrell' ) ) ),
					self::size( __( 'Gap: Featured to List', 'farrell' ), 'column_gap', '34', $layout ),
					self::size( __( 'Gap Between List Items', 'farrell' ), 'row_gap', '34', $layout ),
					self::size( __( 'List Photo Width', 'farrell' ), 'item_media_w', '196', $layout ),
					...
					self::size( __( 'Badge Font Size', 'farrell' ), 'date_size', '13', $date ),
					array(
						'type'             => 'textfield',
