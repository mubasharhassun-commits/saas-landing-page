			...
			array(
				...
				'params'      => array(
					...
					array(
						...
						'group'            => $content,
						'edit_field_class' => 'vc_col-sm-6',
						'description'      => __( 'Words to keep before the ellipsis. 0 keeps the whole title.', 'farrell' ),
					),
					array(
						'type'             => 'textfield',
					...
					array(
						'type'             => 'dropdown',
						'heading'          => __( 'Photo Fit', 'farrell' ),
						'param_name'       => 'media_fit',
						'value'            => array(
							__( 'Fill the frame, crop the rest', 'farrell' ) => 'cover',
							__( 'Fit the whole photo inside', 'farrell' )    => 'contain',
						),
						'std'              => 'cover',
						'group'            => $layout,
						'edit_field_class' => 'vc_col-sm-6',
						'description'      => __( 'Fill looks fuller but cuts a wide photo down to its middle. Fit keeps every photo whole and shows the placeholder colour around it.', 'farrell' ),
					),
					array(
						'type'             => 'dropdown',
						'heading'          => __( 'Photo Position', 'farrell' ),
						'param_name'       => 'media_position',
						'value'            => array(
							__( 'Center', 'farrell' )       => 'center',
							__( 'Top', 'farrell' )          => 'top',
							__( 'Bottom', 'farrell' )       => 'bottom',
							__( 'Left', 'farrell' )         => 'left',
							__( 'Right', 'farrell' )        => 'right',
							__( 'Top left', 'farrell' )     => 'top left',
							__( 'Top right', 'farrell' )    => 'top right',
							__( 'Bottom left', 'farrell' )  => 'bottom left',
							__( 'Bottom right', 'farrell' ) => 'bottom right',
						),
						'std'              => 'center',
						'group'            => $layout,
						'edit_field_class' => 'vc_col-sm-6',
						'description'      => __( 'Which part of the photo survives a crop. Top is usually right for group photographs, so heads are not cut off.', 'farrell' ),
					),
					...
					self::size( __( 'List Title Lines', 'farrell' ), 'item_title_lines', '3', $titles, array( 'description' => __( 'Every list heading is exactly this many lines deep, so two beside each other always match. 0 lets each be its own height.', 'farrell' ) ) ),
					...
					self::size( __( 'List Text Lines', 'farrell' ), 'item_text_lines', '3', $text, array( 'description' => __( 'Every list paragraph is exactly this many lines deep. 0 lets each be its own height.', 'farrell' ) ) ),
